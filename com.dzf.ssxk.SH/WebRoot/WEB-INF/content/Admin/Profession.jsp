	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="card form" id="form1">
				...
				<br>
				<form action="Profession/insert" method="post">
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<label for="exampleInputEmail1">所属科系</label>

								<select class="form-control" id="depselect" name="profession.department.DepartmentID"
									onchange="loadpro()">
							...
							<div class="form-group">
								<label for="exampleInputPassword1">专业名称</label> <input
									type="type" class="form-control" id="ProfessionName"
									placeholder="ProfessionName" name="profession.ProfessionName">
							</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								<label for="exampleInputEmail1">专业编号</label> <input type="type"
									class="form-control" id="ProfessionID"
									aria-describedby="emailHelp" placeholder="ProfessionID"
...
<script>
		...
		function loadpro(){
			 ...
			 $.ajax({
				...
				success:function(data){
				     ...
				     for(var i=0;i<data.length;i++){
						...
						trhtml+="</td><td><a href='javascript:void(0)' onclick='rowselect("+(i+1)+")'>修改</a>&nbsp;<a href='Profession/delete?ProfessionID="
						trhtml+=data[i].professionID+"'onclick='javascript:return del();'>删除</a></td></tr>";
			...
			function rowselect(index) {
				...
				$("#ProfessionID").val(tb.rows[index].cells[3].innerHTML);
				$("#ProfessionName").val(tb.rows[index].cells[4].innerHTML);
