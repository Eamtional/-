						...
						<div class="col-md-6">
							...
							<div class="form-group">
								<label for="exampleInputPassword1">真实姓名</label> <input
									...
									placeholder="AdminName" name="admin.AdminName">
							</div>
							<div class="form-group">
								<label for="exampleInputPassword1">账户类型</label> 
								<select class="form-control" id="Role" name="admin.Role">
						...
						<div class="col-md-6">
							<div class="form-group">
								<label for="exampleInputPassword1">密码</label> <input
									...
									placeholder="Password" name="admin.Password">
							</div>
							<div class="form-group">
					...
					success : function(json) {
						...
						for (var i = 0; i < json.length; i++) {
							...
							trhtml += "<td><a href='javascript:void(0);' onclick='rowselect("
									+ (i + 1) + ")'>修改</a>&nbsp;&nbsp;";
							trhtml += "<a  href='Admin/delete?AdminID="
									+ json[i].adminID + "'onclick='javascript:return del();'>删除</a>&nbsp;&nbsp;";
							trhtml += "<a href='Admin/pwdrestore?AdminID="
									+ json[i].adminID + "'>重置</a></td></tr>";
