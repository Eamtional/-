	...
	<nav class="navbar navbar-expand-lg ">
			...
			<div class="container-fluid ">
					...
					<ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
							...
							<!-- Search-->
							<li class="nav-item d-flex align-items-center"><a id="search" class="nav-link" href="#"></a></li>
			...
			<ul class="list-unstyled">
					<li><a href="#pages" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-file-o"></i>基础信息管理 </a>
						<ul id="pages" class="collapse list-unstyled">
								<li><a href="Admain/College.jsp">分院信息管理</a></li> 
								<li><a href="Admain/Department.jsp">系部信息管理</a></li> 
								<li><a href="Admain/Profession.jsp">专业信息管理</a></li> 
								<li><a href="Admain/Class.jsp">班级信息管理</a></li> 
								<li><a href="Admain/CourseTable.jsp">课程信息管理</a></li> 
								<li><a href="Admain/Student.jsp">学生信息管理</a></li> 
								<li><a href="Admain/Teacher.jsp">教师信息管理</a></li> 
					...
					<li><a href="#apps" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>账户信息管理 </a>
							<ul id="apps" class="collapse list-unstyled">
									<li><a href="Admain/Admin.jsp">管理员账户管理</a></li> 
					...
					<li class="active"><a href="#forms" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-building-o"></i>个人信息维护 </a>
							<ul id="forms" class="collapse list-unstyled">
									<li class="active"><a href="Admain/Personal.jsp">个人信息修改</a></li> 
									<li><a href="Admain/Pwdupdate.jsp">账户密码修改</a></li> 
							</ul>
					</li>
